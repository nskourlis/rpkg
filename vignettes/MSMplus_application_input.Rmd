---
title: "Preparing the Input files for MSMplus"
...
results3_days=rpkg::msboxes_R(data=msebmt,id= msebmt$id, yb=c(0.3,0.5,0.75),
                        ...
                        tmat.= tmat, time_study=msebmt$Tstop,vartime=c(seq(0,10,by=0.1)),scale=365.25,
                        jsonpath="C:/Users/niksko/Desktop/mstate3/datasets/json/flexsurv/json_present_flexsurv/", name="msboxes_EBMT_R.json" ) 
```
